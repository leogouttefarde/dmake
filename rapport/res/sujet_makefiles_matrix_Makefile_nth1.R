pdf("sujet_makefiles_matrix_Makefile_nth1.pdf")
...
data <- c( 3059,  1343,  808,  596,  496,  425,  377,  345,  323,  298,  278,  269,  251,  225 )
...
prefix="sujet_makefiles_matrix_Makefile_nth1"
