pdf("sujet_makefiles_premier_Makefile_nth1.pdf")
...
data <- c( 1260385,  1182082,  1084616,  971473,  850033,  709642,  560273,  401357,  238402,  107486,  107508,  107480,  107498,  107474 )
...
prefix="sujet_makefiles_premier_Makefile_nth1"
