pdf("sujet_makefiles_blender_249_Makefile-recurse_nth1.pdf")
...
data <- c( 78680,  38753,  29185,  23864,  21283,  18546,  18073,  16799,  17582,  15749,  15872,  16593,  16101,  15544 )
...
prefix="sujet_makefiles_blender_249_Makefile-recurse_nth1"
