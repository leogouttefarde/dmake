pdf("sujet_makefiles_blender_249_Makefile_nth1.pdf")
...
data <- c( 78549,  38137,  27906,  23836,  21193,  20658,  19441,  16188,  15639,  15028,  15138,  15914,  16055,  17604 )
...
prefix="sujet_makefiles_blender_249_Makefile_nth1"
