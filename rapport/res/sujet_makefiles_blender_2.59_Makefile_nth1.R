pdf("sujet_makefiles_blender_259_Makefile_nth1.pdf")
...
data <- c( 120941,  55061,  39810,  32788,  27180,  20663,  22199,  19538,  19874,  21372,  19626,  19086,  16939,  18001 )
...
prefix="sujet_makefiles_blender_259_Makefile_nth1"
