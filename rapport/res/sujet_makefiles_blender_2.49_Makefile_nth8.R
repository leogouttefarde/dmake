pdf("sujet_makefiles_blender_249_Makefile_nth8.pdf")
...
data <- c( 21313,  10974,  14194,  12078,  10796,  10349,  10912,  10994,  10888,  10884,  10826,  10954,  11009,  10989,  11873 )
...
prefix="sujet_makefiles_blender_249_Makefile_nth8"
