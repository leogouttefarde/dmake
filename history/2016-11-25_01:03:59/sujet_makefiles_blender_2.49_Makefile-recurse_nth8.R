pdf("sujet_makefiles_blender_2.49_Makefile-recurse_nth8.pdf")
...
data <- c( 21386,  11752,  14145,  12790,  10855,  10383,  10428,  10464,  10412,  10417,  10409,  10502,  10442,  10469,  10437 )
