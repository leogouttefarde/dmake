pdf("sujet_makefiles_blender_2.49_Makefile-recurse_nth4.pdf")
...
data <- c( 28836,  14960,  12870,  13706,  13905,  14079,  13565,  11576,  10972,  10427,  10119,  10071,  10080,  10046,  10594 )
