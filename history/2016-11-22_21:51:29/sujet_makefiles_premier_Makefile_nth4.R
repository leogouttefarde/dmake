pdf("sujet_makefiles_premier_Makefile_nth4.pdf")
...
data <- c( 468828,  387200,  107496,  107495,  107486,  107730,  107489,  107510,  107497,  107500,  107500,  107496,  107513,  107507,  136803 )
